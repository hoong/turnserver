...
/* USER_ID */
#define TURN_ATTR_USER_ID

/* SESSION_ID */
#define TURN_ATTR_SESSION_ID
...
#define TURN_ERROR_402            "Authentication failed" // 91u extra
 ...
 *
 */
struct turn_attr_user_id
{
  uint16_t turn_attr_type; /**< Attribute type */
  uint16_t turn_attr_len; /**< Length of "value" */
  uint64_t turn_attr_id; /**<  User ID */
}__attribute__((packed));
 ...
 *
 */
struct turn_attr_session_id
{
  uint16_t turn_attr_type; /**< Attribute type */
  uint16_t turn_attr_len; /**< Length of "value" */
  uint8_t turn_attr_session[]; /**<  Session ID string*/
}__attribute__((packed));
